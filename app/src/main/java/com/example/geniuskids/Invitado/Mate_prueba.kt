...
import com.example.geniuskids.Materias.Matematicas.WebViewTos
import com.example.geniuskids.R
import com.example.geniuskids.niveles.dificultad_matematicas
import com.google.firebase.firestore.FirebaseFirestore
import com.google.firebase.firestore.Query

class Mate_prueba : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_mate_prueba)
        ...
        cargarVideos("Fácil", "Matemática",1)
    }
    private fun cargarVideos(dificultad: String, materia: String, orderNumber: Int) {
    ...
    private fun openWebView(videoUrl: String) {
        val intent = Intent(this, web_prueba::class.java)
