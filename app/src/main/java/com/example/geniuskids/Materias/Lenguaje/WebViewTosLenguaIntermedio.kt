...
import com.example.geniuskids.Materias.Ciencias.Basico
import com.example.geniuskids.R

class WebViewTosLenguaIntermedio : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_web_view_tos_lengua_intermedio)
